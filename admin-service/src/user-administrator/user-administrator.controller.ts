...
export class UserAdministratorController {
  constructor(
    private readonly userAdministratorService: UserAdministratorService,
  ) {}
  ...
  @ApiResponse({
    status: 200,
    description: 'Returned user-Administrator by id',
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'User-Administrator already exists',
  })
  @Post()
  async create(
